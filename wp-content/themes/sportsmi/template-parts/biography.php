<?php
    ...
    $author_info = get_the_author_meta( 'bentox_write_by');
    $facebook_url = get_the_author_meta( 'bentox_facebook' );
    $twitter_url = get_the_author_meta( 'bentox_twitter' );
    $linkedin_url = get_the_author_meta( 'bentox_linkedin' );
    $instagram_url = get_the_author_meta( 'bentox_instagram' );
    $bentox_url = get_the_author_meta( 'bentox_youtube' );
    $bentox_write_by = get_the_author_meta( 'bentox_write_by' );
