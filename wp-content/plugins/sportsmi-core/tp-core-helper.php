...
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-event.php');
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-team.php');
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-facility.php');
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-trainings.php');
...
include_once(TPCORE_WIDGET_PATH . '/tp-social-list.php');
