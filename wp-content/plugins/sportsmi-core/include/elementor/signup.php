 ...
 * @since 1.0.0
 */
class TP_signup extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Lets Get Started!', 'sportsmi-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'rows' => 10,
                'default' => esc_html__('Please Enter your Email Address to join our club', 'sportsmi-core'),
        ...
        $this->add_control(
            'form_bg_style_color',
            [
                'label'     => esc_html__('Form Color', 'sportsmi-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .contact-form__inner' => 'background-color: {{VALUE}};',
                ],
            ]
        );
                    ...
                    <div class="col-lg-8 col-xxl-6">
                        <div class="authentication__wrapper">
                            <?php if (!empty($settings['sportsmi_heading_content_title'])) :   ?>
                                <h4 class="title"><?php echo wp_kses($settings['sportsmi_heading_content_title'], wp_kses_allowed_html('post'))  ?></h4>
                            <?php endif ?>
                            <?php if (!empty($settings['sportsmi_heading_content_description'])) :   ?>
                                <p class="counter_text"><?php echo wp_kses($settings['sportsmi_heading_content_description'], wp_kses_allowed_html('post'))  ?></p>
                            <?php endif ?>
...
$widgets_manager->register(new TP_signup());
