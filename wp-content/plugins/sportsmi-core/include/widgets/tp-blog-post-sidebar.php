            ...
            <div class="rc__post">
                ...
                <div class="rc__thumb f-left">
                    <a href="<?php the_permalink(); ?>">
						<img src="<?php print esc_url(get_the_post_thumbnail_url(get_the_ID(),'full')); ?>" alt="Blog">
					</a>
                </div>
                <?php endif; ?>
                <div class="rc__content fix">
					<h6 class="rc__title mb-2"><a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 4, ''); ?></a></h6>
					<div class="rc__meta">
